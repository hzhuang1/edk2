...
STATIC struct HiKeyBootEntry Entries[] = {
  [HIKEY_BOOT_ENTRY_FASTBOOT] = {
    // can't work
    //L"VenHw(B549F005-4BD4-4020-A0CB-06F42BDA68C3)/HD(4,GPT,496847AB-56A1-4CD5-A1AD-47F4ACF055C9,0x2000,0x4000)/FvFile(9588502a-5370-11e3-8631-d7c5951364c8)",
    //L"VenHw(B549F005-4BD4-4020-A0CB-06F42BDA68C3)/HD(4,GPT,496847AB-56A1-4CD5-A1AD-47F4ACF055C9,0x2000,0x4000)/Fv(9E21FD93-9C72-4C15-8C4B-E77F1DB2D792)/FvFile(9588502a-5370-11e3-8631-d7c5951364c8)",
    // can't work
    //L"MemoryMapped(0xB,0x35000000,0x350EFFFF)/FvFile(9588502a-5370-11e3-8631-d7c5951364c8)",
    //L"MemoryMapped(0x0,0x35000000,0x350EFFFF)/FvFile(9588502a-5370-11e3-8631-d7c5951364c8)",
    //L"MemoryMapped(0x1,0x35000000,0x350EFFFF)/Fv(9E21FD93-9C72-4C15-8C4B-E77F1DB2D792)/FvFile(9588502a-5370-11e3-8631-d7c5951364c8)",
    // can work
    L"MemoryMapped(0xB,0x3DA72000,0x3DD2013F)/FvFile(9588502a-5370-11e3-8631-d7c5951364c8)",
    // can't work
    //L"MemoryMapped(0xB,0x3DA72000,0x3DD2013F)/Fv(9E21FD93-9C72-4C15-8C4B-E77F1DB2D792)/FvFile(9588502a-5370-11e3-8631-d7c5951364c8)",
    NULL,
    L"fastboot",
