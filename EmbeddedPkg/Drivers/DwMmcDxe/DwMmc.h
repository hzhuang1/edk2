...
extern EFI_PHYSICAL_ADDRESS      mDwMmcRegisterBase;

// DW MMC Registers
#define DWMMC_CTRL		(mDwMmcRegisterBase + 0x000)
#define DWMMC_PWREN		(mDwMmcRegisterBase + 0x004)
#define DWMMC_CLKDIV		(mDwMmcRegisterBase + 0x008)
#define DWMMC_CLKSRC		(mDwMmcRegisterBase + 0x00c)
#define DWMMC_CLKENA		(mDwMmcRegisterBase + 0x010)
#define DWMMC_TMOUT		(mDwMmcRegisterBase + 0x014)
#define DWMMC_CTYPE		(mDwMmcRegisterBase + 0x018)
#define DWMMC_BLKSIZ		(mDwMmcRegisterBase + 0x01c)
#define DWMMC_BYTCNT		(mDwMmcRegisterBase + 0x020)
#define DWMMC_INTMASK		(mDwMmcRegisterBase + 0x024)
#define DWMMC_CMDARG		(mDwMmcRegisterBase + 0x028)
#define DWMMC_CMD		(mDwMmcRegisterBase + 0x02c)
#define DWMMC_RESP0		(mDwMmcRegisterBase + 0x030)
#define DWMMC_RESP1		(mDwMmcRegisterBase + 0x034)
#define DWMMC_RESP2		(mDwMmcRegisterBase + 0x038)
#define DWMMC_RESP3		(mDwMmcRegisterBase + 0x03c)
#define DWMMC_RINTSTS		(mDwMmcRegisterBase + 0x044)
#define DWMMC_STATUS		(mDwMmcRegisterBase + 0x048)
#define DWMMC_FIFOTH		(mDwMmcRegisterBase + 0x04c)
#define DWMMC_TCBCNT		(mDwMmcRegisterBase + 0x05c)
#define DWMMC_TBBCNT		(mDwMmcRegisterBase + 0x060)
#define DWMMC_DEBNCE		(mDwMmcRegisterBase + 0x064)
#define DWMMC_UHSREG		(mDwMmcRegisterBase + 0x074)
#define DWMMC_BMOD		(mDwMmcRegisterBase + 0x080)
#define DWMMC_DBADDR		(mDwMmcRegisterBase + 0x088)
#define DWMMC_IDSTS		(mDwMmcRegisterBase + 0x08c)
#define DWMMC_IDINTEN		(mDwMmcRegisterBase + 0x090)
#define DWMMC_DSCADDR		(mDwMmcRegisterBase + 0x094)
#define DWMMC_BUFADDR		(mDwMmcRegisterBase + 0x098)
#define DWMMC_CARDTHRCTL	(mDwMmcRegisterBase + 0X100)
#define DWMMC_FIFO_START        (mDwMmcRegisterBase + 0x200)
